...
<div className="mx-auto right-0 mt-2 w-60">
                <div className="bg-white rounded overflow-hidden shadow-lg flex flex-col">
                    ...
                    <Image key={pokemons.id} src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${pokemons.id}.svg`} alt={pokemons.name} priority={false} width={100} height={100}/>
                    <p className="capitalize pt-2 text-lg font-semibold text-gray-50">{pokemons.name}</p>
